...
const WORDPRESS_URL = process.env.NEXT_PUBLIC_WORDPRESS_URL || 'https://digiwebtech.co.in/wp-blog';
...
export async function savePost() {
  throw new Error('Post writing is disabled on Node.js. Use WordPress /wp-blog/wp-admin to manage posts.');
}

export async function deletePost() {
  throw new Error('Post deletion is disabled on Node.js. Use WordPress /wp-blog/wp-admin to manage posts.');
}
